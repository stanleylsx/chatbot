...
if __name__ == '__main__':
    ...
    train_file = '../data/qa_corpus/raw/train.txt'
    test_file = '../data/qa_corpus/raw/test.txt'
    stopword_file = '../data/stopwords/stopwords.txt'
    embeding = '../word2vec/70000-small.txt'
    vocab_file = '../data/qa_corpus/project-data/word_vocab.txt'
    max_q_length = 15
    max_a_length = 15
    embeding_size = 200
    main()
